# This code was taken from https://github.com/facebookresearch/online-dt/blob/main/decision_transformer/models/decision_transformer.py
import torch
...
class DecisionTransformer(TrajectoryModel):
    ...
    def forward(
        ...
        print("batch size, seq_length",states.shape)
        ...
        x = x.reshape(batch_size,3, self.hidden_size)
